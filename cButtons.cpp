...
void cButtons::render(int textureToRender)
{
...
void cButtons::update(string fileName, string map)
{
...
gameState cButtons::update(gameState theCurrentGameState, gameState newGameState)
{
...
bool cButtons::getClicked()
{
	return clicked;
}
void cButtons::setClicked(bool state)
{
	clicked = state;
}
