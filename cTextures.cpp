...
cTextures::cTextures()
{
	cTextures::GLTextureID = NULL;
}

cTextures::cTextures(LPCSTR theFilename)
{
	cTextures::createTexture(theFilename);
}
...
=================
*/
bool cTextures::createTexture(LPCSTR theFilename) 	// create the texture for use.
{
...
=================
*/
GLuint cTextures::getTexture()        // return the texture.
{
	return cTextures::GLTextureID;
}
...
=================
*/
GLsizei cTextures::getTWidth() 						// Return width of texture;
{
	return textureWidth;
}
/*
...
=================
*/
GLsizei cTextures::getTHeight() 						// Return height of texture;
{
